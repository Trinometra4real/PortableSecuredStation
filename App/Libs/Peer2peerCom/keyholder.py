...
class KeyHolder:
    ...
    def encrypt(self, data:bytes, public:rsa.PublicKey) -> bytes:
    ...
    def signMessage(self, msg:bytes)-> bytes:
        signed = rsa.sign(msg, self.private, "SHA-256")
        return signed
    
    def decrypt(self, encrypted:bytes)-> bytes:
        return rsa.decrypt(encrypted, self.private)

    def getPublic(self) -> rsa.PublicKey:
        return self.public
